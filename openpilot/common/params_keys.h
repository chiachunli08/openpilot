...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"MapboxMapDisplayEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"NavigationModelEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"NavigationModelFusionEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"NavigationModelFusionCompatible", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    {"NavigationModelFusionActive", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BOOL, "0"}},
    {"NavigationModelInstallStatus", {PERSISTENT, STRING}},
    {"NavigationTurnPromptEnabled", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"NavigationRouteCache", {PERSISTENT | DONT_LOG, JSON}},
    {"NavigationRouteDestination", {PERSISTENT | DONT_LOG, JSON}},
    {"NavigationRouteMetadata", {PERSISTENT | DONT_LOG, JSON}},
