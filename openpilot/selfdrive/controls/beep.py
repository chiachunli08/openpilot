  ...
  def update_alert(self, new_alert):
    if new_alert != self.current_alert:
      ...
      if new_alert == AudibleAlert.engage:
        ...
        self.dispatch_beep(self.warning)
      elif new_alert in [AudibleAlert.longEngaged, AudibleAlert.longDisengaged, AudibleAlert.trafficSignGreen,
                         AudibleAlert.trafficSignChanged, AudibleAlert.trafficError, AudibleAlert.bsdWarning,
                         AudibleAlert.laneChange, AudibleAlert.leadCarMoving]:
        self.dispatch_beep(self.ding)
      elif new_alert in [AudibleAlert.stopStop, AudibleAlert.stopping, AudibleAlert.autoHold, AudibleAlert.engage2,
                         AudibleAlert.disengage2, AudibleAlert.speedDown, AudibleAlert.audioTurn, AudibleAlert.reverseGear]:
